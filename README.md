...
|Links|Description|
|-----|-----|
|[Art Convention](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Art-Conventions)|These are the conventions the artists set up|
|[Build](https://github.com/Wispyru/MagicalDoctorPrettyClinic/releases/tag/Build)|De link naar de build|
|[Code Conventions](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Code-conventions)|The conventions the developers agreed on.|
|[Complete Codebase](https://github.com/Wispyru/MagicalDoctorPrettyClinic)|The complete codebase|
|[Full code documentation](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Full-code-documentation)| This is the full documentation of the code|
|[Functional Design](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Functional-Design)| |
|[Git Conventions](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Git-Conventions)| Conventions the team agreed on for the usage of github|
|[Notula Sprint Refinement](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Notula-Sprint-Refinement)|The notes for the stuff we were going to improve after the sprint feedback|
|[Notula sprint Review](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Notula-Sprint-Review)|Notes that were made during the sprint review|
|[Notula daily scrum](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Notule-daily-scrum)|Notes made every morning and end of the day by the Scrum Master (credits to Sanne for the cleaned up notes)|
|[Notula sprint planning](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Notule-Sprintplanning)| Plans for each sprint |
|[Pipeline Agreements](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Pipeline-Agreements)| Agreements made about the order and direction of working. |
|[Product Backlog](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Product-Backlog)|These are all the user stories together with the assigned todo's|
|[Sprint Retrospectives](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Sprint-Retrospective)|Notes made during the retrospectives every sprint|
|[Technical Design](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Technical-Design)|Issues we ran into during development, and how we fixed those issues.|
|[Used Software](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/Used-Software)|The software that was used to create this game.|
|[User Tests](https://github.com/Wispyru/MagicalDoctorPrettyClinic/wiki/User-Tests)| The user tests we ran with the feedback and our next course of action.|
